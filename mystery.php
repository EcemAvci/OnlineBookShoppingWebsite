<head>
    ...
    <title> Mystery&Crime Books Listing Page</title>
</head>
...
<div class="Title"><h3>Showing  Mystery&Crime Books</h3></div>
<div class="row">
<?php    
$query = $db->query("select * from book where book_category='Mystery&Crime' ");
