<head>
    ...
    <title>Biography Books Listing Page</title>
</head>
<?php include 'header.php' ?>
<?php include 'connection.php' ?>
<body>
<div id="bookListing" class="container" >
<div class="Title"><h3>Showing Biography Books</h3></div>
<div class="row">
<?php    
$query = $db->query("select * from book where book_category='Biography' ");
